...
function M.install_defaults(state, mappings, codux, mode_action_desc)
  ...
  M.set(state, "n", mappings.diagnostics, codux.send_diagnostics, "send diagnostics to codex")
  M.set(state, "n", mappings.diff, codux.send_git_diff, "send git diff to codex")
