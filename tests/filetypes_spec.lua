...
assert_true(filetypes.is_workspace("codux-workspaces"))
assert_true(filetypes.workspace_manager["codux-workspaces"] == true)
assert_false(filetypes.workspace_manager["codux-workspace-instruction"] == true)
