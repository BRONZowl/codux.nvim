...
assert_equal(workspace_git.normalize_agent_mode("plan"), "plan")
assert_equal(workspace_git.normalize_agent_mode("execute"), "execute")
assert_equal(workspace_git.normalize_agent_mode("read-only"), nil)
assert_true(workspace_git.inactive_like_status("inactive"))
assert_true(workspace_git.inactive_like_status("missing"))
assert_false(workspace_git.inactive_like_status("active"))
assert_false(workspace_git.inactive_like_status("idle"))
