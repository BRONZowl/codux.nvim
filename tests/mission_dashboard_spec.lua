...
do
  ...
  assert_equal(command_text:find("a answer", 1, true), nil)
  assert_equal(command_text:find("p prompt", 1, true), nil)
  assert_equal(command_text:find("i interrupt", 1, true), nil)
  assert_equal(command_text:find("s mode", 1, true), nil)
